...
Answer: We're trying to add the arrays with the `+` operator which converts the arrays
to strings which we are then attempting to join. Since already a string `dishName`
can't invoke the method `join`.

Concatenate with concat or join earlier
*/