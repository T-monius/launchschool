...
class TodoListTest < MiniTest::Test
  ...
  def test_todo_inquiry
    @list.done!

    assert_equal(true, @list.pop.done?)
  end
  ...
  def test_todo_undone
    ...
    @todo3.undone!
    assert_equal(false, @list.pop.done?)
  end
  ...
  def test_todo_description
    @todo1.description = 'Ours is spoiled!'

    assert_equal('Ours is spoiled!', @todo1.description)
  end

  def test_todo_title
    @todo1.title = 'Buy grade A milk'

    assert_equal('Buy grade A milk', @todo1.title)
  end
