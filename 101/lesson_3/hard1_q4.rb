...
# determines if a string is a valid ip address number and asked Ben
# to use it.
...
# you're not handling the case that there are more or fewer than 4
# components to the IP address (e.g. "4.5.5" or "1.2.3.4.5" should be
# invalid)."
...
#   If true next
#   else return false
# Cases greator or less than 4 components
#   immediately return if dot_separated_words.length != 4
...
puts dot_separated_ip_address?("1.@.23.3")
