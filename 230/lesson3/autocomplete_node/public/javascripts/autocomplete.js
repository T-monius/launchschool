...
var Autocomplete = {
  ...
  listClicked: function(event) {
    // event.currentTarget here represents the list (ul)
    // event.target here should represent the actual list item clicked (li)
    // event.target.textContent should give me the value clicked
