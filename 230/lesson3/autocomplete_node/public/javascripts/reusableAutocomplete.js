...
Autocomplete.prototype.bindEvents = function() {
  ...
  this.listUI.addEventListener('mousedown', this.listClicked.bind(this));
};

Autocomplete.prototype.listClicked = function(event) {
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  autocomplete.valueChanged = debounce(autocomplete.valueChanged.bind(autocomplete), 300);

  autocomplete.wrapInput();
  autocomplete.createUI();
